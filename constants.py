...
ATUMN_DAWN_COLOR = Color(205, 131, 122)
ATUMN_DAY_COLOR = Color(254, 212, 86)
ATUMN_DUSK_COLOR = Color(165, 91, 82)
ATUMN_NIGHT_COLOR = Color(46, 54, 87)
ATUMN_COLORS = [ATUMN_DAWN_COLOR, ATUMN_DAY_COLOR, ATUMN_DUSK_COLOR, ATUMN_NIGHT_COLOR]
