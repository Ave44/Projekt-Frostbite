...
from game.animated_entities.domain.AggressiveMob import AggressiveMob
...
class GoblinChampion(AggressiveMob):
    def __init__(self, visibleSprites: CameraSpriteGroup, obstacleSprites: ObstacleSprites,
        ...
        AggressiveMob.__init__(self, visibleSprites, obstacleSprites, loadedImages.goblinchampion, loadedSounds.goblin, entityData, clock, midbottom, currHealth)
